    ...
    <>
      ...
      <SimpleGrid cols={{ base: 1, md: 2 }} spacing="xl" p="lg">
          ...
          <Stack spacing="md">
            {productList.map((item) => (
              <Group key={item.id} align="flex-start">
                <Image src={item.product_image} w="10%" maw={60} radius="md" />
                ...
                <Group>
                  ...
                  <Text fw={600}>₹{item.product_price * item.product_qty}</Text>
                </Group>
              </Group>
            ))}
          </Stack>
        ...
        <Paper shadow="md" radius="md" p="lg">
          ...
          <TextInput placeholder="Enter your code" label="Promo Code" mt="md" />
